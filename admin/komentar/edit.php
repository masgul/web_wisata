...
<?php
    ...
    $query = mysqli_query($kon, "SELECT * FROM komentar k inner join artikel a on a.id_artikel=k.id_artikel where nmor=$nmor");
...
?>
    ...
    <div class="form-group">
            <input name="nmor" value="<?php echo $id; ?>" type="hidden" class="form-control">
