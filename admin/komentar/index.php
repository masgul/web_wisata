            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                        ...
                        $sql="select * from komentar k inner join artikel a on a.id_artikel=k.id_artikel order by nmor desc";
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn-edit btn btn-warning btn-circle" nmor="<?php echo $data['nmor']; ?>"  >Edit</button>
                            <button class="btn-hapus btn btn-danger btn-circle"  nmor="<?php echo $data['nmor']; ?>" >Hapus</button>
                        </td>
                    </tr>
    ...
    $('.btn-edit').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById("judul").innerHTML='Edit komentar #'+nmor;
            }
        });
        // Membuka modal
        $('#modal').modal('show');
